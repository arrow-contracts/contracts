...
// Official Uniswap V2 Router02 on Base mainnet, verified on-chain before use here:
// router.factory() matches this factory, router.WETH() matches Base's canonical WETH
// (0x4200...0006), and factory.allPairsLength() returned 3,045,156 live pairs.
address constant BASE_MAINNET_ROUTER = 0x4752ba5DBc23f44D87826276BF6Fd6b1C372aD24;

contract ArrowBaseTest is Test {
    ...
    function setUp() public {
        ...
        factory =
            new ArrowFactory(owner, BASE_MAINNET_ROUTER, address(new TokenDeployer()), address(new CurveDeployer()));
